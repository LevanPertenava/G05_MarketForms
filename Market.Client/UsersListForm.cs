...
namespace Market.Client
{
    public partial class UsersListForm : Form, IListForm
    {
        ...
        public UsersListForm()
        {
            ...
            _userRepository = new(@"server = DESKTOP-V7759FH\SQLEXPRESS;database=Market;integrated security=true");
        }
        ...
        {
            return new Add<User>(this);
        }

        public Form GetEditForm()
        {
            return new Edit<User>(this, _userId);
        }
    }
}
